...
*** Variables ***
${github_host_url}    ${credentials_dict}[envDictGithub][githubPage]
${github_account_username}    ${credentials_dict}[envDictGithub][githubAccountEmail]
${github_account_password}    ${credentials_dict}[envDictGithub][githubAccountPassword]
